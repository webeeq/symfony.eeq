...
class EditUserForm
{
     ...
     *     min=8,
     *     max=30,
     *     minMessage="Stare hasło musi zawierać minimalnie {{ limit }} znaków.",
     *     maxMessage="Stare hasło może zawierać maksymalnie {{ limit }} znaków."
     * )
     */
    protected $password;
     ...
     *     min=8,
     *     max=30,
     *     minMessage="Nowe hasło musi zawierać minimalnie {{ limit }} znaków.",
     *     maxMessage="Nowe hasło może zawierać maksymalnie {{ limit }} znaków."
     * )
     */
    ...
    public function isOldPasswordValid(): bool
    {
        $idPassword = $this->em->getRepository('App:User')
            ->isIdPassword($this->user, $this->password ?? '');

        return $this->password != '' && !$idPassword;
    }
