 ...
 */
final class Version20200521091130 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE site (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED DEFAULT NULL, active TINYINT(1) NOT NULL, visible TINYINT(1) NOT NULL, name VARCHAR(180) NOT NULL, url VARCHAR(180) NOT NULL, ip_added VARCHAR(15) NOT NULL, date_added DATETIME NOT NULL, ip_updated VARCHAR(15) NOT NULL, date_updated DATETIME NOT NULL, INDEX IDX_694309E4A76ED395 (user_id), INDEX active (active), INDEX visible (visible), INDEX date_added (date_added), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT UNSIGNED AUTO_INCREMENT NOT NULL, province_id SMALLINT UNSIGNED DEFAULT NULL, city_id SMALLINT UNSIGNED DEFAULT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', name VARCHAR(30) NOT NULL, surname VARCHAR(50) NOT NULL, url VARCHAR(180) NOT NULL, phone VARCHAR(20) NOT NULL, street VARCHAR(60) NOT NULL, postcode VARCHAR(6) NOT NULL, description TEXT NOT NULL, `show` INT UNSIGNED NOT NULL, ip_added VARCHAR(15) NOT NULL, date_added DATETIME NOT NULL, ip_updated VARCHAR(15) NOT NULL, date_updated DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D64992FC23A8 (username_canonical), UNIQUE INDEX UNIQ_8D93D649A0D96FBF (email_canonical), UNIQUE INDEX UNIQ_8D93D649C05FB297 (confirmation_token), INDEX IDX_8D93D649E946114A (province_id), INDEX IDX_8D93D6498BAC62AF (city_id), INDEX `show` (`show`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
